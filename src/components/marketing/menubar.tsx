...
const Menubar = ({ items, handleClose, children }: MenubarProps) => {
  ...
  return (
    <div
      onClick={handleClose}
      className={cn(
        "fixed inset-0 top-16 z-50 grid h-[calc(100vh-4rem)] grid-flow-row auto-rows-max overflow-auto p-6 pb-32 shadow-md  md:hidden bg-glassmorphism backdrop-blur-xl"
      )}
    >
