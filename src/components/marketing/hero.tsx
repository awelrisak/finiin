...
export default function Hero() {
  return (
    <div className="relative py-6 min-h-[calc(100dvh-5rem)]">
      <Spotlight
        className="-top-40 left-0 fill-white md:-top-20 md:left-60"
        // fill="white"
      />

      <h1 className="px-6 pb-5 text-center font-heading text-4xl text-balance bg-gradient-to-b from-neutral-950 to-neutral-500 bg-clip-text  text-transparent dark:from-neutral-50 dark:to-neutral-700 md:text-7xl">
        More Customers. More Sales.
        <br />
        Finiin makes it possible.
      </h1>
