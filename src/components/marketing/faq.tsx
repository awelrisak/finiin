  ...
  return (
    <div className=" mt-10 w-full rounded-3xl md:py-10">
      <div className=" p-10 md:p-4 md:px-20">
        <div className="text-3xl font-boldtext-neutral-950 md:text-7xl ">
          Have questions ?
        </div>
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            <AccordionTrigger>What is Sonamax?</AccordionTrigger>
            <AccordionContent>
              Sonamax is a full fledge marketing agency that specializes in
